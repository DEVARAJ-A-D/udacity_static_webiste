...
FILES INCLUDED
website/ index.html — Main HTML page css/ style.css — All styles (responsive, animated) js/ app.js — Interactivity (navbar, modal, form, counters) img/ hero.jpg — Hero background image
...
S3 BUCKET POLICY (IAM — Make Public)
...
Upload ALL files maintaining the folder structure: • index.html • css/style.css • js/app.js • img/hero.jpg
CLOUDFRONT DISTRIBUTION

AWS Console → CloudFront → Create Distribution
Origin domain: Select your S3 bucket website endpoint (use the S3 website endpoint, not the REST endpoint)
